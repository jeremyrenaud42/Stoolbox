...
Get-RemoteFile "Background_diag.jpeg" 'https://raw.githubusercontent.com/jeremyrenaud42/Bat/main/assets/Default/Background_diag.jpeg' "$pathDiagnostiqueSource"
