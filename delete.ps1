...
if($preverif)
{
    ...
    Remove-Item  "$env:SystemDrive_Tech\*" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null #Ca prend cette ligne si executer depuis C:\_tech. Ca va laisser le odssier _tech vide, mais au moins ca marchera.
