...
$window.add_Loaded({
    ...
    $formControls.btnForceUpdate_Menu.Add_Click({
        ...
        $window.Close()
        Get-RemoteFileForce "MenuMainWindow.xaml" "https://raw.githubusercontent.com/jeremyrenaud42/Stoolbox/main/MenuMainWindow.xaml" "$env:SystemDrive\_Tech\Applications\source"
        Get-RemoteFileForce "Resources.xaml" "https://raw.githubusercontent.com/jeremyrenaud42/Stoolbox/main/Resources.xaml" "$env:SystemDrive\_Tech\Applications\source"
        Get-RemoteFileForce "Settings.JSON" "https://raw.githubusercontent.com/jeremyrenaud42/Stoolbox/main/Settings.JSON" "$env:SystemDrive\_Tech\Applications\source"
        Restart-Elevated -Path "$env:SystemDrive\_Tech\Menu.ps1"
    })
